...
config.imgDir = "http://20.226.21.160/imagens/vrp_images/" -- DIRETORIO DAS IMAGENS DOS VEÍCULOS
...
config.garages = {
	[1] = { type = 'public', coords = vec3(53.98,-878.08,30.38), perm = nil,
	  vehiclePositions = {
		[1] = { vec3(51.26,-892.13,30.17), h = 336.98 },
		[2] = { vec3(47.94,-891.2,30.17), h = 336.98 },
		[3] = { vec3(44.6,-889.82,30.19), h = 336.98 },
		[4] = { vec3(41.35,-888.79,30.19), h = 336.98 },
		[5] = { vec3(8.02,-887.63,30.2), h = 336.98 },
		[6] = { vec3(39.57,-883.02,30.27), h = 162.37 },
		[7] = { vec3(42.82,-884.19,30.26), h = 162.37 },
		[8] = { vec3(46.21,-885.46,30.25), h = 162.37 },
		[9] = { vec3(49.49,-886.7,30.24), h = 162.37 },
		[10] = { vec3(52.67,-887.75,30.24), h = 162.37 },
		[11] = { vec3(50.71,-873.18,30.44), h = 336.98 },
		[12] = { vec3(47.53,-871.9,30.46), h = 336.98 },
		[13] = { vec3(44.16,-870.61,30.47), h = 336.98 },
		[14] = { vec3(47.48,-861.64,30.61), h = 336.98 },
		[15] = { vec3(50.68,-862.98,30.59), h = 336.98 },
		[16] = { vec3(54.03,-864.23,30.58), h = 336.98 },
		[17] = { vec3(57.26,-865.43,30.57), h = 336.98 },
		[18] = { vec3(60.42,-866.6,30.56), h = 336.98 },
	  },
	},
	[2] = { type = 'public', coords = vec3(1991.12,3778.15,32.19), perm = nil,
	  vehiclePositions = {
		[1] = { vec3(1994.76,3763.39,32.19), h = 209.04 },
		[2] = { vec3(1992.44,3762.03,32.19), h = 209.04 },
		[3] = { vec3(1990.08,3760.54,32.18), h = 209.04 },
	  },
	},
	[3] = { type = 'public', coords = vec3(154.57,6643.41,31.61), perm = nill,
	  vehiclePositions = {
		[1] = { vec3(147.51,6639.8,31.59), h = 319.17 },
		[2] = { vec3(150.55,6635.8,31.63), h = 319.17 },
	  },
	},
   }
