...
config.imgDir = "http://181.215.254.36/vrp_images/" -- DIRETORIO DAS IMAGENS DOS VEÍCULOS
...
config.maxDistance = 3000 -- distância máxima (em radius(raio)) que o player poderá ir quando estiver realizando o test drive
...
config.vehList = {
	...
	{ hash = -380714779, name = 'bme6tun', price = 100000000, banido = false, modelo = 'BMW M5', capacidade = 50, tipo = 'exclusive' },
